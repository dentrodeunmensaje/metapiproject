...
function Department(props) {
  ...
  return (
    <div className="department">
      ...
      <div>
        <p className="text-justify">&emsp;The Museum of Costume Art was founded by Aline Bernstein and Irene Lewisohn. In 1946, with the financial support of the fashion industry, the Museum of Costume Art merged with The Metropolitan Museum of Art as The Costume Institute, and in 1959 became a curatorial department. Today, its collection contains more than 35,000 costumes and accessories.</p>
        </div>
        }
      ...
      {/* <p>Se está renderizando un dept</p>
       ...
       {!departmentSearchMade ?( <div class="d-grid gap-2"><button onClick={getWorks} className="btn btn-success btn-block art-btn">SHOW ME THE ART!</button> </div> ): null}
